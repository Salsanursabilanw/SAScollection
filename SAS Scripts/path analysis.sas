...
RUN;
ODS GRAPHICS OFF;
PROC CORR DATA=contoh;
VAR Kualitas_Produk Harga Pelayanan;
PROC CALIS DATA=contoh;
path
Loyalitas_Pelanggan<-Kepuasan_Pelanggan,
Loyalitas_Pelanggan<-Kualitas_Produk,
Loyalitas_Pelanggan<-Pelayanan,
Kepuasan_Pelanggan<-Kualitas_Produk,
Kepuasan_Pelanggan<-Harga,
Kepuasan_Pelanggan<-Pelayanan;
effpart
Loyalitas_Pelanggan<-Kualitas_Produk Pelayanan;
RUN; 
